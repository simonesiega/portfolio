 ...
 */
export function ParticleNetwork({className, motionScale, disablePointer}: ParticleNetworkProps) {
  const canvasRef = useParticleNetwork({motionScale, disablePointer});
