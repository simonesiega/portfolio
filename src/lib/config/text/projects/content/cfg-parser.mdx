...
Calculating the answer was familiar. What interested me was encoding _why_ one operation must happen before another—and making invalid input fail at the layer that could explain it.
